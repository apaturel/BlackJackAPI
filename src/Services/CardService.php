...
class CardService
{
    ...
    public function HitACard(EntityManagerInterface $entityManager, $doctrine, $deckId, int $playerId){
        ...
        // $newShoe = array_slice($shoe, 10, $nbLeftCards);
        // $nbLeftCards -= 1;
